            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 md:p-12">
              <div className="mb-12">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700 mt-1">
                        ...
                        using BeaconPay. By accessing or using our services, you
                ...
                <p className="text-gray-700 leading-relaxed">
                  Welcome to BeaconPay. These Terms of Service govern your use
              ...
              <section id="acceptance" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  <p>
                    By accessing or using BeaconPay, you confirm that you are at
                    least 18 years old and have the legal capacity to enter into
                    these Terms of Service. If you are using BeaconPay on behalf
              ...
              <section id="services" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  <p>
                    BeaconPay provides a comprehensive workspace management
              ...
              <section id="accounts" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  <p>
                    To access certain features of BeaconPay, you must create an
                  ...
                  <p>
                    ...
                    confidentiality of your account credentials. BeaconPay will
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-4">
                    <p className="text-sm text-amber-900 font-medium">
                      ...
                      BeaconPay staff will never ask for your password.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section id="payment" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  <p>
                    BeaconPay offers various subscription plans and payment
              ...
              <section id="conduct" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  <p>
                    You agree to use BeaconPay only for lawful purposes and in
              ...
              <section id="liability" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  <p>
                    <strong>Disclaimer:</strong> BeaconPay is provided &quot;as
                  ...
                  <p>
                    ...
                    by law, BeaconPay and its affiliates, officers, directors,
                  ...
                  <p>
                    ...
                    use of BeaconPay shall not exceed the amount you paid us in
              ...
              <section id="changes" className="mb-10 scroll-mt-8">
                ...
                <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
                  ...
                  <p>
                    Your continued use of BeaconPay after changes become
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <a
                            href="mailto:legal@BeaconPay.com"
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            BeaconPay Inc., Abuja, FCT, Nigeria
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="border-t border-gray-200 pt-8 mt-12">
                ...
                <div className="space-y-4 text-sm text-gray-700">
                  ...
                  <p>
                    ...
                    from these Terms or your use of BeaconPay shall be resolved
                  ...
                  <p>
                    ...
                    you and BeaconPay regarding the use of our services.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 mb-4">
                    By using BeaconPay, you acknowledge that you have read,
